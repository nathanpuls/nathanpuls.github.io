var links = [{label: 'voice over', bg: '#c0392b', url: 'http://sayingthings.com'}, 
             {label: 'google', bg: '#16a085', url: 'http://google.com'}, 
             {label: 'link3', bg: '#8e44ad', url: 'http://google.com'}, 
             {label: 'link4', bg: '#27ae60', url: 'http://google.com'}, 
             {label: 'link5', bg: '#f39c12', url: 'http://google.com'}, 
             {label: 'link6', bg: '#2980b9', url: 'http://google.com'}];
